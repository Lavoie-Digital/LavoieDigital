...
const DESCRIPTION =
  "Création de site web à Québec : sites vitrines, boutiques en ligne et refontes codés sur mesure pour les PME. Livré en 2 semaines. Devis fixe, appel gratuit.";
...
export const metadata: Metadata = {
  ...
  title: "Création de site web à Québec",
  ...
  openGraph: {
    title: "Création de site web à Québec — Lavoie Digital",
    description: DESCRIPTION,
...
export default function CreationSiteWebQuebecPage() {
  return (
    <LandingPage
      data={SITE_WEB}
      prev={{ href: "/services", label: "Tous les services", eyebrow: "Voir aussi" }}
      next={{
        href: "/creation-application-web-quebec",
        label: "Création d'application web",
